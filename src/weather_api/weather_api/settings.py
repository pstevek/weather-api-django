...
SECRET_KEY = 'vd7x*t(nn_l5!nc6enpa&u!eb%*+x60bagdz12@9bmer50d&hi'
...
OPENWEATHER_API_URL = parser.get('openweather', 'api_url')
OPENWEATHER_API_KEY = parser.get('openweather', 'api_key')
